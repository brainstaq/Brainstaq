class BrainstormsController < ApplicationController
  include BrainstormScoped, Concepted, DoneVoting
  ...
  def start_brainstorm
    @brainstorm.state = :conception
    StateChannel.broadcast_to @brainstorm, { event: "set_brainstorm_state", state: "conception" }
  ...
  def start_voting
    ...
    transmit_concepts(sort_by_id_desc, Brainstorm::DynamicVoteCounter.new(@brainstorm).votes)
  end
  ...
  def end_voting
    ...
    transmit_concepts(sort_by_votes_desc)
  end
