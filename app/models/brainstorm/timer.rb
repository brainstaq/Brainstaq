class Brainstorm::Timer
  include Kredis::Attributes, Concepted, DoneVoting
  ...
  def check_expiry
    if expired?
      ...
      broadcast :expired
      broadcast_concepts :transmit_concepts, transmit_concepts(sort_by_id_desc, Brainstorm::DynamicVoteCounter.new(brainstorm).votes)
